...
#'
#' Returns product-level import demand elasticities using 3-digit HS0 estimates from Broda and Weinstein (QJE, 2006) for 73 countries.
#'
...
#'
#' get_sigma(sourcevar = c("21170", "69978", "21170", "21171"), origin = "SITC3",
