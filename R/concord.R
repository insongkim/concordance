...
#' @param dest.digit An integer indicating the preferred number of digits for outputs. The default is 2 digits for concordance with BEC and 4 digits otherwise.
