...
#' @param origin A string setting the input industry classification: "HS" (combined), "HS0" (1988/92), "HS1" (1996), "HS2" (2002), "HS3" (2007), "HS4" (2012), "HS5" (2017), "HS6" (2022), "SITC1" (1950), "SITC2" (1974), "SITC3" (1985), and "SITC4" (2006).
#' @param destination A string setting the output industry classification: "HS" (combined), "HS0" (1988/92), "HS1" (1996), "HS2" (2002), "HS3" (2007), "HS4" (2012), "HS5" (2017), "HS6" (2022), "SITC1" (1950), "SITC2" (1974), "SITC3" (1985), "SITC4" (2006).
