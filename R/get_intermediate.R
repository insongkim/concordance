...
#' }
#' @note Please include leading zeros in codes (e.g., use HS code 010110 instead of 10110, use BEC4 code 700 instead of 7)---results may be buggy otherwise. Also note that the results may not be informative for broad categories like BEC4.
