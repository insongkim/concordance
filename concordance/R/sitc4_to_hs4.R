#' Converts SITC4 to HS4 Codes
#'
#' \code{concord_sitc4_hs4} converts SITC4 Revision 4 to HS4 codes.
#'
...
#' concord_sitc4_hs4(sourcevar = "22240", origin = "SITC4", destination = "HS4", all = FALSE)
#' concord_sitc4_hs4(sourcevar = "22240", origin = "SITC4", destination = "HS4", all = TRUE)
#'
#' # two inputs: one-to-multiple match
#' concord_sitc4_hs4(sourcevar = c("22240", "00119"), origin = "SITC4", destination = "HS4", all = FALSE)
#' concord_sitc4_hs4(sourcevar = c("22240", "00119"), origin = "SITC4", destination = "HS4", all = TRUE)
#'
#' # two inputs: repeated
#' concord_sitc4_hs4(sourcevar = c("22240", "22240"), origin = "SITC4", destination = "HS4", all = FALSE)
#' concord_sitc4_hs4(sourcevar = c("22240", "22240"), origin = "SITC4", destination = "HS4", all = TRUE)
#'
#' # sourcevar has different number of digits, will give an error
#' concord_sitc4_hs4(sourcevar = c("22240", "2224"), origin = "SITC4", destination = "HS4", all = FALSE)
#'
#' # If no match, will return NA
#' concord_sitc4_hs4(sourcevar = c("22240", "22241"), origin = "SITC4", destination = "HS4", all = FALSE)
#'
#' # 4-digit inputs
#' concord_sitc4_hs4(sourcevar = c("2224", "0011"), origin = "SITC4", destination = "HS4", all = FALSE)
#'
#' # 4-digit outputs
#' concord_sitc4_hs4(sourcevar = c("22240", "00119"), origin = "SITC4", destination = "HS4", dest.digit = 4, all = FALSE)
concord_sitc4_hs4 <- function (sourcevar,
                               origin,
                               destination,
                               dest.digit = 6,
                               all = FALSE) {
