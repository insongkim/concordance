...
#' @importFrom rlang := !!
#' @export
#' @references Concordances draw on HS-NAICS concordance tables between 1989 and 2017 from Pierce and Schott (2009, 2018) <https://faculty.som.yale.edu/peterschott/international-trade-data/>.
#' @examples
