...
#' @param destination A string setting the output industry classification: "HS" (HS combined), "HS0" (1988/92), "HS1" (1996), "HS2" (2002), "HS3" (2007), "HS4" (2012), "HS5" (2017), "SITC1", "SITC2", "SITC3", "SITC4".
...
#' @importFrom rlang := !!
#' @export
#' @references Concordances draw on concordance tables provided by the World Bank's World Integrated Trade Solution (WITS) <https://wits.worldbank.org/product_concordance.html> and United Nations Trade Statistics <https://unstats.un.org/unsd/trade/classifications/correspondence-tables.asp>.
#' @examples
...
#'
#' ## HS/HS0/HS1/HS2/HS3/HS4/HS5 to SITC4
#' concord_hs_sitc(sourcevar = c("1206", "8546"),
#'                 origin = "HS", destination = "SITC4",
#'                 dest.digit = 5, all = TRUE)
#' concord_hs_sitc(sourcevar = c("1206", "8546"),
...
#'                 dest.digit = 5, all = TRUE)
#'
#' ## SITC4 to HS/HS0/HS1/HS2/HS3/HS4/HS5
#' concord_hs_sitc(sourcevar = c("2224", "7732"),
...
#'                 dest.digit = 6, all = TRUE)
#'
#' ## HS/HS0/HS1/HS2/HS3/HS4/HS5 to SITC3
#' concord_hs_sitc(sourcevar = c("1206", "8546"),
...
#'                 dest.digit = 5, all = TRUE)
#'
#' ## SITC3 to HS/HS0/HS1/HS2/HS3/HS4/HS5
#' concord_hs_sitc(sourcevar = c("2224", "7732"),
...
#'                 dest.digit = 6, all = TRUE)
#'
#' ## HS/HS0/HS1/HS2/HS3/HS4/HS5 to SITC2
#' concord_hs_sitc(sourcevar = c("1206", "8546"),
...
#'                 dest.digit = 5, all = TRUE)
#'
#' ## SITC2 to HS/HS0/HS1/HS2/HS3/HS4/HS5
#' concord_hs_sitc(sourcevar = c("2224", "7732"),
...
#'                 dest.digit = 6, all = TRUE)
#'
#' ## HS/HS0/HS1/HS2/HS3/HS4/HS5 to SITC1
#' concord_hs_sitc(sourcevar = c("1206", "8546"),
...
#'                 dest.digit = 5, all = TRUE)
#'
#' ## SITC1 to HS/HS0/HS1/HS2/HS3/HS4/HS5 (codes do not exist in SITC1, returns NAs)
#' concord_hs_sitc(sourcevar = c("2224", "7732"),
...
concord_hs_sitc <- function (sourcevar,
  ...
  if ((origin == "HS" | origin == "HS0" | origin == "HS1" | origin == "HS2" | origin == "HS3" | origin == "HS4" | origin == "HS5") & (destination == "SITC1" | destination == "SITC2" | destination == "SITC3"| destination == "SITC4")){
  ...
  } else if ((origin == "SITC1" | origin == "SITC2" | origin == "SITC3" | origin == "SITC4") & (destination == "HS" | destination == "HS0" | destination == "HS1" | destination == "HS2" | destination == "HS3" | destination == "HS4" | destination == "HS5")) {
