...
#' concord_naics_hs2(sourcevar = "111120", origin = "NAICS", destination = "HS2", all = FALSE)
#' concord_naics_hs2(sourcevar = "111120", origin = "NAICS", destination = "HS2", all = TRUE)
#'
#' # two inputs: one-to-multiple match
#' concord_naics_hs2(sourcevar = c("111120", "326199"), origin = "NAICS", destination = "HS2", all = FALSE)
#' concord_naics_hs2(sourcevar = c("111120", "326199"), origin = "NAICS", destination = "HS2", all = TRUE)
#'
#' # two inputs: repeated
#' concord_naics_hs2(sourcevar = c("111120", "111120"), origin = "NAICS", destination = "HS2", all = FALSE)
#' concord_naics_hs2(sourcevar = c("111120", "111120"), origin = "NAICS", destination = "HS2", all = TRUE)
#'
#' # sourcevar has different number of digits, will give an error
#' concord_naics_hs2(sourcevar = c("111120", "11112"), origin = "NAICS", destination = "HS2", all = FALSE)
#'
#' # If no match, will return NA
#' concord_naics_hs2(sourcevar = c("111120", "111121"), origin = "NAICS", destination = "HS2", all = FALSE)
#'
#' # 4-digit inputs
#' concord_naics_hs2(sourcevar = c("1111", "3271"), origin = "NAICS", destination = "HS2", all = FALSE)
#'
#' # 4-digit outputs
#' concord_naics_hs2(sourcevar = c("111120", "326199"), origin = "NAICS", destination = "HS2", dest.digit = 4, all = FALSE)
concord_naics_hs2 <- function (sourcevar,
                               origin,
                               destination,
                               dest.digit = 6,
                               all = FALSE) {
