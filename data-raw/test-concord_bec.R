...
concord_hs_bec(sourcevar = c("11", "21"), origin = "BEC4", destination = "HS0", dest.digit = 4, all = FALSE)

concord_hs_bec(sourcevar = c("11", "21"), origin = "BEC4", destination = "HS4", dest.digit = 4, all = FALSE)
...
get_intermediate(sourcevar = c("063", "052"), origin = "BEC4")
get_intermediate(sourcevar = c("064", "052"), origin = "BEC4")
